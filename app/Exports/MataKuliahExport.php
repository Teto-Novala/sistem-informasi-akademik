...
class MataKuliahExport implements FromCollection,WithHeadings,WithStyles,ShouldAutoSize
{
    /**
    ...
    */
    ...
    {
        return MataKuliah::select('kode_mk','nama','sks')->get();
    }

    public function headings():array{
        return["Nama",'Kode Mata Kuliah','SKS'];
    }
